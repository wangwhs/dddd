...
public class ConcurrentHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
	...
	static final class Segment<K, V> extends ReentrantLock implements Serializable {
		 ...
		 */
		transient int count;//��ǰsegment�а����ڵ�Ԫ�ص�����
			...
			for (int i = 0; i < oldCapacity; i++) {
				...
				if (e != null) {
					...
					if (next == null) {
						...
						int lastIdx = idx;
						/*Ѱ������֮�󣬲���ԭ���������ϵ����һ���ڵ�lastRun������ڵ�֮�������Ԫ��Ҳ�ض�����ԭ�����ϣ�Ҳ����ת�Ƶ��µ�����*/
						...
						/*�������֮�����lastIdx����������HashEntry�е��±�*/
						
						/*
						 * �ص�ע�⣺
						 * 		1����ΪHashEntry[]�������Ǳ����ģ�ʼ����2���ݴη�������ĳ��HashEntry����HashEntry[]�������±���㷨Ϊ��i = (e.hash >> segmentShift) & segmentMask; 
						 *     	2����������֮ǰHashEntry[]�ĳ���Ϊ2��k�η���Ҫȷ��ĳ��hashEntry��HashEntry[]�е��±�m�����������㷨��mֻ��hashֵ�ĺ�kλ�й�;
						 *     	3������֮��HashEntry[]�ĳ��ȱ�Ϊ��2��k+1�η�������Ϊhash��segmentShift��SegmentMask��Ϊfinal�����Լ�������±�nֻ��hashֵ�ĺ�k+1λ�йأ�
						 *      4����2���͵�3���ĵĺ�kλ�ͺ�k+1λ������ֻ�ڵ�k+1λ����λҪôΪ0��ҪôΪ1����������ǰ�󣬽ڵ�����������е��±������¹�ϵ��m == n ���� m+(k<<1) = n;
						 *      5�����ݵ�4���ó��Ľ��ۣ�����֮ǰÿһ�����ϵ�HashEntry�ڵ�����֮��ֻ���������ֲַ������a�����ֲ���ԭ�����±�Ϊm���ϣ�b���ֲ����µ�m+(k<<1)�������ϣ�k������0;
						 */
						
						/*�����������5���ó��Ľ��ۣ�����֮ǰ��ͬ�����ϵ�Ԫ������֮���ǲ����ֲܷ���ͬһ�����ϵģ����Ծ������¸�ֵ���� ,��lastRun֮�������Ԫ�ظ�ֵ���µ����ϣ�Ҳ�п��ܾ���*/
						newTable[lastIdx] = lastRun;
						/* ��lastRun֮ǰ�Ľڵ����ͷ�巨���뵽�����ͷ�� */
			...
			try {
				...
				while (e != null) {
					...
					if ((k = e.key) == key || ((e.hash == hash) && k.equals(key))) {
						V v = e.value;
						/* ValueΪnull��ʱ��ֻƥ��key,����key��value����Ҫƥ�� */
	...
	static final <K, V> HashEntry<K, V> entryForHash(Segment<K, V> seg, int h) {
		/* ����hashֵ��ȡ��ǰsegment�У�ά����HashEntry�����е�ĳһ������ͷ��� */
		HashEntry<K, V>[] tab;
	...
	public boolean isEmpty() {
		...
		/*
		 * ����˼·�Ǳ�������segment[]���飬���������� ��һ�α�����
		 * �ڱ����Ĺ��������κ�һ��segment��Ԫ��������Ϊ�գ�����������false,������ۼ�ÿ��segment��д�����Ĵ���modCount;
		 * ��һ�α�������������ۼӵ�д�����Ĵ���Ϊ0��ֱ�ӷ���true��˵��segment[]������û���κ�Ԫ�أ������ٽ��еڶ��α������κ�һ��segment��Ϊ��
		 * ���򷵻�false, ����ͽ��е�һ�μ�����ۼ�д��������sum�ļ���������ֱ�����������е�segment,��������֮��sum������0��˵����
		 * �������α����Ĺ����з�����һ��д���������Աض���Ϊ�ա�
		 */
		long sum = 0L;
	 ...
	 */
	public int size() {
		/* ͳ��size�Ĺ����п��Բ�ͬ��segment���в�����д����������ֻ����Ե�ͳ��ĳһ��ʱ�䷶Χ�ڵ�size��С */
		final Segment<K, V>[] segments = this.segments;
		int size;// ����Ĵ�С
		long sum;// ���ּ�����ۼƲ�������
		long last = 0L;// ��һ�μ�����ۼƲ�������
		int retries = -1;// ��ʼ���Դ���
		boolean overflow;// size�Ƿ����
		try {
			/*
			 * ����˼·���������ȳ��Լ���size,�������3�Σ�Ҫ�������������Դ����ķ�Χ�ڣ�segment[]��û�з�������д�������������
			 * ��������е�segment���м�����ͳ��size
			 */
			for (;;) {
				/* ���Դ����ﵽ����ֵ,������еĶν��м������� */
				...
				/* ���β����޸ĵĴ���һ��˵�����ʱ���size���ȶ��ģ���ͳ��size����������������ԣ��ﵽ��ֵ���Բ��ȶ����������segment������Ȼ���ټ��� */
				if (sum == last) {
					break;
				}
				last = sum;
